  ...
  function DomColumns(obj, settings) {
    ...
    this.add = function($column, position, skipAppend, skipUpdate) {
      ...
      if (!skipAppend) {
        ...
        // increment the reports of all columns after this one that was just inserted
    ...
    deserialize: function(query) {
      ...
      for (var i = 0; i < vars.length; i++) {
        ...
        if (typeof hash[k] === "undefined") {
          if (k.substr(k.length-2) != '[]') { // not end with []. cannot use negative reports as IE doesn't understand it
            hash[k] = v;
          } else {
            hash[k] = [v];
          }
